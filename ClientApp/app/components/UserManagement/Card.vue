...
<template>
  <div class="flex items-center justify-between p-4 bg-light-background dark:bg-dark-background rounded-lg">
    ...
    <div class="flex items-center space-x-4">
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center gap-2 text-sm">
          ...
          <span v-if="userCopy.globalRole" class="px-2 py-0.5 bg-light-primary/10 dark:bg-dark-primary/10 text-light-primary dark:text-dark-primary rounded-full text-xs">
    ...
    <div class="flex items-center gap-4">
      ...
      <div v-if="canManage && !isCurrentUser" class="flex items-center gap-2">
        <Switch
        ...
        >
          <span class="inline-block h-4 w-4 transform bg-white rounded-full transition" :class="userCopy.isActive ? 'translate-x-6' : 'translate-x-1'" />
        </Switch>

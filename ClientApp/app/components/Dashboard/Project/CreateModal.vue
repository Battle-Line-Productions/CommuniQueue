<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-light-surface dark:bg-dark-surface p-6 rounded-lg w-full max-w-md">
      <h2 class="text-xl font-semibold mb-4 text-light-textbase dark:text-dark-textbase">Create New Project</h2>
      <form @submit.prevent="handleSubmit">
        <div class="mb-4">
          <label for="projectName" class="block text-sm font-medium text-light-textbase dark:text-dark-textbase mb-1">Project Name</label>
          <input
            id="projectName"
            v-model="projectName"
            type="text"
        ...
        <div class="mb-4">
          <label for="projectDescription" class="block text-sm font-medium text-light-textbase dark:text-dark-textbase mb-1">Description</label>
          <textarea
        ...
        <div class="flex justify-end">
          <button type="button" class="mr-2 px-4 py-2 text-light-secondary dark:text-dark-secondary hover:underline" @click="$emit('close')"> Cancel </button>
          <button
            type="submit"
            :disabled="isPending"

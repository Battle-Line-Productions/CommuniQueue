...
{
    Task<ResponseDetail<(ApiKey?, string?)>> GenerateApiKeyAsync(Guid projectId, DateTime startDate, DateTime endDate, List<string> scopes, string requesterSsoId);
    ...
    Task<ResponseDetail<bool>> ExpireApiKeyAsync(Guid apiKeyId, string requesterSsoId);

...
{
    Task<ResponseDetail<Permission?>> CreatePermissionAsync(Guid userId, Guid entityId, EntityType entityType, PermissionLevel permissionLevel);
    ...
    Task<ResponseDetail<Permission>> UpdatePermissionAsync(Guid userId, Guid entityId, EntityType entityType, PermissionLevel newPermissionLevel);
    Task<ResponseDetail<bool>> DeletePermissionAsync(Guid userId, Guid entityId, EntityType entityType);
}

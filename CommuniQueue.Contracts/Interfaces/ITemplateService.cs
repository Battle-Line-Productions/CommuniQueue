...
{
    Task<ResponseDetail<Template>> CreateTemplateAsync(Guid projectId, Guid containerId, string name, string subject, string body, string requesterSsoId);
    ...
    Task<ResponseDetail<TemplateVersion>> CreateNewVersionAsync(Guid templateId, string subject, string body, string requesterSsoId);
    ...
    Task<ResponseDetail<bool>> AssignVersionToStageAsync(Guid templateVersionId, Guid stageId, string requesterSsoId);
    Task<ResponseDetail<bool>> RemoveVersionFromStageAsync(Guid templateVersionId, Guid stageId, string requesterSsoId);

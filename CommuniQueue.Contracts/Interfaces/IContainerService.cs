...
public interface IContainerService
{
    ...
    Task<ResponseDetail<Container>> UpdateContainerAsync(Guid containerId, string name, string description);
    Task<ResponseDetail<bool>> DeleteContainerAsync(Guid containerId);
    Task<ResponseDetail<List<Container>>> GetChildContainersAsync(Guid parentContainerId);
    Task<ResponseDetail<bool>> MoveContainerAsync(Guid containerId, Guid? newParentContainerId);
}

...
namespace CommuniQueue.DataAccess.Migrations
{
    ...
    [Migration("20241104055225_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommuniQueue.Contracts.Models.Project", b =>
                {
                    ...
                    b.Property<Guid>("RootContainerId")
                        .HasColumnType("uuid")
                        .HasColumnName("root_container_id");
                    ...
                    b.HasIndex("RootContainerId")
                        .IsUnique()
                        .HasDatabaseName("ix_projects_root_container_id");
            ...
            modelBuilder.Entity("CommuniQueue.Contracts.Models.Project", b =>
                {
                    b.HasOne("CommuniQueue.Contracts.Models.Container", "RootContainer")
                        .WithOne()
                        .HasForeignKey("CommuniQueue.Contracts.Models.Project", "RootContainerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_projects_containers_root_container_id");
